...
//yg gk tau nomer nanda nih nomer nya
//http://wa.me/6283162388082?text=bg%20izin%20taroh%20nama%20di%20bot%20mu%20yak
...
handler.help = ['ɪʙɴᴜ ɴʀ','Nanda Style','Xinz-Team','Nayla Chan','Ramlan ID','Van','All creator bot']
handler.tags = ['thanks']
handler.customPrefix = /(\?$)/
handler.command = /^nandaganteng$/i
handler.owner = false
handler.mods = false
